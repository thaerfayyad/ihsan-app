            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$category->description}}</a>
                        </td>
                        <td>
                            <span
                                class="label label-lg @if($category->status) label-light-success @else label-light-danger @endif label-inline">{{$category->active_status}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$category->created_at}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$category->updated_at}}</span>
                        </td>
                        <td>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <path
                                                ...
                                                fill="#000000" fill-rule="nonzero" opacategory="0.3" />
                                        </g>
                                    </svg>
                                    <!--end::Svg Icon-->
                                </span>
