    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-info card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span
                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{$usersCount}}</span>
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bgi-no-repeat card-stretch gutter-b"
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span
                    class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$ordersTotal}}₪</span>
        ...
        <div class="card card-custom bg-danger card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="svg-icon svg-icon-white svg-icon-2x">
                    ...
                    <!--end::Svg Icon--></span>
                <span
                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{$productsCount}}</span>
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-dark card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span
                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 text-hover-primary d-block">{{$contactRequestsCount}}</span>
                            ...
                            <table class="table table-borderless table-vertical-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$user->gender_name}}</span>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div>
                                                ...
                                                {{-- <a class="text-muted font-weight-bold text-hover-primary"
                                                    href="#">{{$user->mobile}}</a> --}}
                                                <span
                                                    class="text-muted font-weight-500">{{$user->created_at->format('Y-m-d')}}</span>
                                            </div>
                                        </td>
                                        <td class="text-right">
                                            <span
