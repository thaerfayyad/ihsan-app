            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$admin->email_verifier_at ?? '-'}}</span>
                            <span
                                class="text-muted font-weight-bold">{{!is_null($admin->email_verifier_at) ? 'Verified' : 'Not Verified'}}</span>
                        </td>
                        <td>
                            <span
