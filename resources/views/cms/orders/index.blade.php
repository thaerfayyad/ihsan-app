            ...
            <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <span class="text-muted font-weight-bold d-block">{{ $order->address_address }}</span>
                            </div>
                        </td>
                        ...
                        <td>
                            <div>
                                <span
                                    class="text-dark-75 font-weight-bolder d-block font-size-lg"></span>
                                <span class="text-muted font-weight-bold d-block">{{ $order->status }}</span>
                            </div>
                        </td>
                ...
                <span
                    class="text-muted font-weight-bold">{{!is_null($product->email_verifier_at) ? 'Verified' : 'Not Verified'}}</span>
                        ...
                        <td class="pr-0 text-right" style="margin-right: 50%">
...
@section('scripts')
    ...
    <script>
        function performDestroy(id, reference) {
            confirmDestroy('/dashboard/orders', id, reference);
        }
